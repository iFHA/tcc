...
Como o Java EE é apenas uma especificação, fez-se o uso de um dos principais frameworks utilizados para desenvolver aplicações RESTful em Java, o Jersey, que implementa todas as características da arquitetura REST.
...
,que possui x e y, um exemplo de pom.xml é apresentado na figura;
...
A figura 5 representa a interface da aplicação cliente desenvolvida.
...
O código da figura 6 diz respeito ao código necessário para realizar a requisição aos serviços do webservice:
...
Assim sendo, na linha 22, têm-se a definição de qual serviço o usuário escolheu, atribuindo-o à variável serviceUrl, que mais tarde será utilizada para redirecionar a requisição para o serviço correto. A Figura \ref{fig:Figura7} exibe as URLs associadas a cada serviço do webservice. Como o middleware está localizado na máquina local, seu acesso se tem por meio da URL \url{http://localhost:8080/demorest/restapi/ws}; 
