...
JSON - como forma padrão de comunicação entre servidor e cliente; codificação base64 - para facilitar a transferência de arquivos binários(imagens, no contexto deste trabalho).
