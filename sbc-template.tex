...
Inicialmente, para criação do projeto, utilizou-se da ferramenta de automatização e gerenciamento de projetos Java denominada Apache Maven, embora também possa ser utilizada com outras linguagens. que possui x e y, um exemplo de pom.xml é apresentado na figura;
