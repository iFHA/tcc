...
Em seguida, é necessário a criação de tais classes. Neste trabalho, foi criada a classe MyResource, no pacote descrito pela linha 12 da figura \ref{fig:Figura9}, Segue na figura \ref{fig:Figura10} o código referente à classe MyResource:
