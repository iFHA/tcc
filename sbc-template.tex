...
Para \cite{coulouris:05} o middleware “é um termo aplicado a uma camada de software
...
nova imagem de obtida \cite{gonzalez:08}.
...
implementado. Estas nuâncias de implementação podem ser abstraídas através do uso de uma API específica que faça a abstração destas tarefas \cite{gonzalez:08,jain:89}.
